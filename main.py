...
if __name__ == "__main__":
    ...
    # model parameters
    parser.add_argument('--model', type=str, default='SMART',
    ...
    parser.add_argument('--nac_order', type=int, default=2,
    ...
    if args.output_name:
        ...
        model.fname = args.model+'R'+str(args.robust)+'_E'+str(args.reg_factor)+'_M'+str(args.n_sampled_memories)+'_Order'+str(args.nac_order)+'_lr'+str(args.lr) +'_iter' +str(args.n_iter) + '_'+ args.data_file + '_'
